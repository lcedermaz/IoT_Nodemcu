...
const char* ssid = "Red-Casa"; // Rellena con el nombre de tu red WiFi
const char* password = "lceder2872"; // Rellena con la contraseña de tu red WiFi

const char* host = "api.wunderground.com";
const char* apiKey = "lucas32860644"; // Puedes obtenerla en
