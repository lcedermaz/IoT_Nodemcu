...
#include "DHT.h"
#define DHTPIN 4     // (2) Digital pin connected to the DHT sensor, Salida digital D2
...
OneWire oneWire(5); // Salida digital D1
DallasTemperature sensors(&oneWire);

float Temp1 ; // Definimos la Variable a mostrar 
